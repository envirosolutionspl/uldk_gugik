...
class UldkGugik:
    ...
    def run(self):
        ...
        self.dlg.projectionWidget.crsChanged.connect(self.update_coord_labels)

    def update_coord_labels(self, crs):

        if crs.postgisSrid() == 4326:
            self.dlg.label_8.setText("Lon")
            self.dlg.label_9.setText("Lat")
        else:
            self.dlg.label_8.setText("X")
            self.dlg.label_9.setText("Y")
