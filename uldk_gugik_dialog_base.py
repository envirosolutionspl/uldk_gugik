...
class Ui_ULDK_GUGIKDialogBase(object):
    def setupUi(self, ULDK_GUGIKDialogBase):
        ...
        self.edit_id_4 = QtWidgets.QLineEdit(self.tab3)
        self.edit_id_4.setGeometry(QtCore.QRect(10, 90, 411, 31))
        self.edit_id_4.setText("")
        self.edit_id_4.setObjectName("edit_id_4")
        self.tabWidget.addTab(self.tab3, "")
        self.groupBox = QtWidgets.QGroupBox(ULDK_GUGIKDialogBase)
        self.groupBox.setGeometry(QtCore.QRect(10, 90, 151, 191))
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 30, 110, 141))
